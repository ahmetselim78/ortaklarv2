...
export const ETIKET_ALAN_META: Record<EtiketAlanAnahtari, {
  ...
  poz: { baslik: 'Poz Numarası', kisa: 'Poz', aciklama: 'Sipariş listesinden gelen poz numarasını boşluksuz P önekiyle basar; uzun değerlerde font otomatik küçültülür', tur: 'metin', renk: '#4d7c0f' },
  liste_adedi: { baslik: 'Toplam Liste Adedi', kisa: 'Toplam adet', aciklama: 'Etikette sayıdan sonra boşluksuz AD basılır (örn. 48AD); karakter sınırı yalnızca sayıya uygulanır', tur: 'metin', renk: '#0369a1' },
