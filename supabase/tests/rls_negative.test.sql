...
SELECT is((SELECT count(*)::integer FROM information_schema.columns WHERE table_schema='public' AND table_name='hr_personel' AND column_name='kullanici_adi'), 0, 'legacy kullanıcı adı kolonu yok');
