-- 059 — AI'a aktarılan açık hataları topluca incelemeye alır.
...
REVOKE ALL ON FUNCTION public.acknowledge_system_errors_for_ai_export(uuid[]) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.acknowledge_system_errors_for_ai_export(uuid[]) TO authenticated;
